...
const expiry = Array.from(document.querySelectorAll(".expiration"));
...
const expMM = document.querySelector(".expiration-month-display");
const expYY = document.querySelector(".expiration-year-display");
...
const expiryErrorMsg = document.getElementById("expiration-error");
